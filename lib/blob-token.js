...
/** Servidor pode gravar no Blob com token estático ou OIDC (BLOB_STORE_ID na Vercel). */
export function blobServidorDisponivel() {
  if (obterTokenBlobLeituraEscrita()) return true;
